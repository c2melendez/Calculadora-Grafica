...
export function ImplicitMultiplicationHint() {
  return (
    <p className="text-xs text-muted" role="note">
      Usa <code className="rounded bg-paper-line/40 px-1 py-0.5">x*y</code>, no{" "}
      <code className="rounded bg-paper-line/40 px-1 py-0.5">xy</code> — los identificadores de varias
      letras (como <code className="rounded bg-paper-line/40 px-1 py-0.5">theta</code>) se interpretan
