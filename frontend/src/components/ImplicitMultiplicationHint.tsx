...
export function ImplicitMultiplicationHint() {
  return (
    <p className="text-xs text-stone-400" role="note">
      Usa <code className="rounded bg-stone-100 px-1 py-0.5">x*y</code>, no{" "}
      <code className="rounded bg-stone-100 px-1 py-0.5">xy</code> — los identificadores de varias
      letras (como <code className="rounded bg-stone-100 px-1 py-0.5">theta</code>) se interpretan
