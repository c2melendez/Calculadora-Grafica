...
export function EquationMode() {
  ...
  return (
    <form onSubmit={handleSubmit} aria-labelledby="equation-mode-heading" className="space-y-4">
      <h2 id="equation-mode-heading" className="text-sm font-medium text-slate-300">
        Ecuación
      </h2>

      <div className="space-y-1">
        <label htmlFor="equation-input" className="block text-sm text-slate-300">
          Ecuación
        </label>
        <input
          id="equation-input"
      ...
      <div className="space-y-1">
        <label htmlFor="equation-variable" className="block text-sm text-slate-300">
        ...
        />
        <p id="equation-variable-hint" className="text-xs text-slate-400" role="note">
      ...
      <div className="space-y-1">
        <label htmlFor="equation-angle-unit" className="block text-sm text-slate-300">
          Unidad angular
        </label>
        <select
